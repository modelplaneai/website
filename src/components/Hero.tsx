    ...
    <section className="hero">
      ...
      <div className="wrap hero-wrap">
        <div className="hero-left">
          <p className="hero-eyebrow">In early development · building in the open</p>
          <img src="/logo-inverted.svg" className="hero-logo" alt="Modelplane" />
          <h1 className="hero-headline">
            The open source control plane for <span className="hero-gradient">AI inference</span>
          </h1>
          ...
          <div className="hero-actions">
            ...
            <a href="https://github.com/modelplaneai" className="btn-ghost" target="_blank" rel="noopener noreferrer">
